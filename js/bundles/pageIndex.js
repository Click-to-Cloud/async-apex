...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('a', null, null, 'href', '/async-apex/tutorials/getting_started/step_1.html', 'class', 'btn btn-accent btn-sm');
    itext('Get Started');
    ie_close('a');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/Async.apex/', 'class', 'btn btn-success btn-sm');
    itext('GitHub');
    ie_close('a');
  ...
  function $why(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Why Async.apex?');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('Async.apex allows a better way to manage synchronous code and asynchronous code in Apex. With Async.apex, you can shift code between synchronous and asynchronous in a promise chain, without losing readability.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $features(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Async.apex chains sync/async codes together, hiding implementation details.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Functional Style');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Async.apex adopts functional style programming, and integrates well with ');
    ...
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Lazy Execution');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Async.apex creates lazy promises, which start execution only when triggered.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
  ...
  function $how(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('Async.apex has fairly simple APIs and you can easily get started with it.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $highlights(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Async.apex has a fluent API that provides most of the Promise features.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/async-apex/images/highlight_1.png', 'alt', 'Fluent API', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Async.apex can be used seamlessly with ');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/R.apex/');
    itext('R.apex');
    ie_open('a');
    itext(' in a functional style.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/async-apex/images/highlight_2.png', 'alt', 'Collection Support', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ie_open('div', null, null, 'class', 'col-md-6 col-md-offset-2');
    ie_open('h4', null, null, 'class', 'highlight-title');
    itext('Error Recovery');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Async.apex support easy error recovery by returning a new Async.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/async-apex/images/highlight_3.png', 'alt', 'Function Composition', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_close('div');
