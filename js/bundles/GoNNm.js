...
var GoNNm = function (_Component) {
  _inherits(GoNNm, _Component);

  function GoNNm() {
    _classCallCheck(this, GoNNm);

    return _possibleConstructorReturn(this, (GoNNm.__proto__ || Object.getPrototypeOf(GoNNm)).apply(this, arguments));
  }
...
_metalSoy2.default.register(GoNNm, _indexSoy2.default);

exports.default = GoNNm;
...
exports.templates = exports.GoNNm = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace GoNNm.
   * @public
   */

  goog.module('GoNNm.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'GoNNm.render';
  }
...
_metalSoy2.default.register(GoNNm, templates);
exports.GoNNm = GoNNm;
