...
var xXMBB = function (_Component) {
  _inherits(xXMBB, _Component);

  function xXMBB() {
    _classCallCheck(this, xXMBB);

    return _possibleConstructorReturn(this, (xXMBB.__proto__ || Object.getPrototypeOf(xXMBB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(xXMBB, _step_2Soy2.default);

exports.default = xXMBB;
...
exports.templates = exports.xXMBB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace xXMBB.
   * @public
   */

  goog.module('xXMBB.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'xXMBB.render';
  }
...
_metalSoy2.default.register(xXMBB, templates);
exports.xXMBB = xXMBB;
