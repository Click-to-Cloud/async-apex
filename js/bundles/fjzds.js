...
var fjzds = function (_Component) {
  _inherits(fjzds, _Component);

  function fjzds() {
    _classCallCheck(this, fjzds);

    return _possibleConstructorReturn(this, (fjzds.__proto__ || Object.getPrototypeOf(fjzds)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fjzds, _step_4Soy2.default);

exports.default = fjzds;
...
exports.templates = exports.fjzds = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace fjzds.
   * @public
   */

  goog.module('fjzds.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'fjzds.render';
  }
...
_metalSoy2.default.register(fjzds, templates);
exports.fjzds = fjzds;
