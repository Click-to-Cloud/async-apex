...
var szzre = function (_Component) {
  _inherits(szzre, _Component);

  function szzre() {
    _classCallCheck(this, szzre);

    return _possibleConstructorReturn(this, (szzre.__proto__ || Object.getPrototypeOf(szzre)).apply(this, arguments));
  }
...
_metalSoy2.default.register(szzre, _step_3Soy2.default);

exports.default = szzre;
...
exports.templates = exports.szzre = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace szzre.
   * @public
   */

  goog.module('szzre.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'szzre.render';
  }
...
_metalSoy2.default.register(szzre, templates);
exports.szzre = szzre;
